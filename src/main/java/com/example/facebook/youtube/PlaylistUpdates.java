...
public class PlaylistUpdates {
    ...
    public static Credential authorize(List<String> scopes, String credentialDatastore) throws IOException {
        ...
        // Load client secrets.
        Reader clientSecretReader = new InputStreamReader(Auth.class.getResourceAsStream(   Auth.jsonFileLocation));
    ...
    public static void fullTest() {
        ...
        try {
            ...
            String item = insertPlaylistItem(playlistId, VIDEO_ID);
    ...
    private static String insertPlaylist() throws IOException {
        ...
        System.out.println();
        System.out.println(playlistInserted.toString());
        System.out.println();
